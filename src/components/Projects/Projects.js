...
const projects = [
  ...
  { number:'04', title:'Budget Buddy', label:'Full-stack product', summary:'A responsive expense tracker that turns monthly income and spending into a clear financial overview and practical guidance.', contribution:'Built a full-stack experience for reviewing transactions, tracking savings progress, and receiving resilient budgeting insights through deterministic rules with optional AI refinement.', tags:['TypeScript','React Native Web','Flask','PostgreSQL','OpenAI'], url:'https://github.com/toeneeoh/Expense-Tracker', demoUrl:'https://expense-tracker.toeneeoh.workers.dev', image:dashboard, imageAlt:'Budget Buddy financial overview in dark mode' },
];
